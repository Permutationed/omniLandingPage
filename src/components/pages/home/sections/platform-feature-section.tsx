import PlatformFeatureSectionMockup from "../mockups/platform-feature-section-mockup";

export default function PlatformFeatureSection() {
  return (
    <section id="platform" className="platform bg-ploy-neutral-primary-s0 py-20 lg:py-32">
      <div className="platform__container max-w-7xl mx-auto px-6 lg:px-8">
        <div className="platform__grid grid items-center gap-12 lg:gap-16 grid-cols-1 lg:grid-cols-2">
          <div className="platform__content">
            <p className="platform__eyebrow tracking-[0.1em] uppercase text-ploy-text-secondary font-medium text-xs mb-4">Platform</p>
