export default function PlatformSectionMockup() {
  return (
    <div
      className="opacity-0 translate-y-[6.25rem] scale-90"
      data-ploy-component-type="mockup"
      data-ploy-component-variant="dashboard"
    >
      <div className="border-solid border-ploy-neutral-inverse-s1 bg-ploy-neutral-primary-s0 overflow-x-hidden overflow-y-hidden border-t border-r border-b border-l">
        <div className="border-solid border-ploy-neutral-primary-s3 flex items-center gap-2 px-4 py-3 border-b">
          ...
          <span className="flex items-center gap-1 ml-auto">
            ...
            <span className="text-ploy-text-secondary text-xs block">Live</span>
          </span>
        </div>
        <div className="p-5">
