export default function TechnologyFeatureSectionMockup3() {
  return (
    <div
      className="opacity-0 translate-x-[7.5rem] lg:order-2"
    ...
    >
      <div className="border-solid border-ploy-neutral-inverse-s1 overflow-x-hidden overflow-y-hidden border-t border-r border-b border-l">
        ...
        <div className="bg-ploy-background-accent-tertiary aspect-video relative overflow-x-hidden overflow-y-hidden">
          <video
